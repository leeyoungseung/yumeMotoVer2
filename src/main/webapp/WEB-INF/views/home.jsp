  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>Yume Moto</b></a>
            <!--logo end-->
            	...
            	<ul class="nav pull-right top-menu">
            		<c:choose>
						<c:when test="${empty  memberInfo}">
                     			<p><a href="/member/login">You are Guest</a><br/></p>
						</c:when>
						<c:otherwise>
							<li><a class="logout" href="login.html">Logout User ${memberInfo.getM_name() }</a></li>
						</c:otherwise>
					</c:choose>
                    ...
                    <!--COMPLETED ACTIONS DONUTS CHART-->
                      ...
                      <div class="desc">
                      	...
                      	<div class="details">
                      			<c:choose>
								<c:when test="${empty  memberInfo}">
                      			<p><a href="/member/login">You are Guest</a><br/>
                      		   		<muted>Available</muted>
                      			</p>
								</c:when>
								<c:otherwise>
								<div>
								<p>${memberInfo.getM_name() }</a><br/>
									<muted>Available</muted>
								</div>
								</c:otherwise>
								</c:choose>
